...
**Screenshot:**
<!-- Add image URL here -->
![IndiGo Pre-checked Checkbox](Project Results\Indigo.png)
...
**Screenshot:**
<!-- Add image URL here -->
![Joom Urgency Pattern](Project Results\Joom.png)
...
**Screenshots:**
<!-- Add image URLs here -->
![LinkedIn AI Training Consent 1](Project Results\Linkdn.png)

*Caption: Pre-checked checkbox for AI training data usage on LinkedIn settings page.*

![LinkedIn AI Training Consent 2](Project Results\Linkdn1.png)
...
**Screenshot:**
<!-- Add image URL here -->
![Mailchimp Opt-In Pattern](Project Results\malchimp.png)
...
**Screenshot:**
<!-- Add image URL here -->
![Temu Scarcity Pattern](Project Results\temu.png)
...
**Screenshot:**
<!-- Add image URL here -->
![ThreadShade Social Proof](Project Results\Threadshade.png)
